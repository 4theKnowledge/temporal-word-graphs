// 2015-05-01 00:43:28
var dateFmt = d3.timeParse("%d/%m/%Y")//"%Y-%m-%d %H:%M:%S");
...
d3.csv("data/Custom_data.csv",
  ...
  function (err, data) {
    ...
    // showing too much... wont render the next function either...
    d3.select("#counter").append("p").html("Showing " + data.length + " Samples");
